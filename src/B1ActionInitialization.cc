...
void B1ActionInitialization::Build() const
{
  ...
  // Actions 
  B1PrimaryGeneratorAction* primaryAction = new B1PrimaryGeneratorAction; // **************
  SetUserAction(primaryAction); //*************************

  B1RunAction* runAction = new B1RunAction(histo);
  SetUserAction(runAction);
  
  B1EventAction* eventAction = new B1EventAction(runAction, primaryAction, histo);  // *********************
  SetUserAction(eventAction);
  
  SetUserAction(new B1SteppingAction(eventAction));  // *** Forma de conectar clases
}  
